...
from ai import ask_ai_with_fallback, get_macros  # ✅ Use guarded version now
...
def ask_ai_func():
    ...
    if st.button("Ask AI"):
        with st.spinner():
            result = ask_ai_with_fallback(st.session_state.profile, user_question)  # ✅ Using guarded version
            st.write(result)
